<body data-background-color="dark">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/jm_denis.jpg" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/chadengle.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/mlane.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/talha.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<div class="notif-center">
										...
										<a href="#">
											<div class="notif-img"> 
												<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/profile2.jpg" alt="Img Profile">
											</div>
											<div class="notif-content">
												<span class="block">
								...
								<div class="quick-scroll scrollbar-outer">
									<div class="quick-content contact-content">
										...
										<div class="avatar-group">
											<div class="avatar">
												<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/assets/img/talha.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
	...
	<script src="./Views/admin/web/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js"></script>
        ...
        <script src="./Views/admin/web/assets/js/plugin/bootstrap-tagsinput/bootstrap-tagsinput.min.js"></script>
	<script>
